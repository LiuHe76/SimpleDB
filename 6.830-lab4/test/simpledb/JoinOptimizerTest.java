...
public class JoinOptimizerTest extends SimpleDbTestBase {
	 ...
	 */
	@Test public void orderJoinsTest() throws ParsingException, IOException, DbException, TransactionAbortedException, NoSuchFieldException {
	 ...
	 */
	@Test(timeout=60000) public void bigOrderJoinsTest() throws IOException, DbException, TransactionAbortedException, ParsingException, NoSuchFieldException {
	 ...
	 */
	@Test public void nonequalityOrderJoinsTest() throws IOException, DbException, TransactionAbortedException, ParsingException, NoSuchFieldException {
		final int IO_COST = 103;
		...
		// Make sure that "bigTable" is the innermost table in the join
		Assert.assertEquals(result.get(result.size()-1).t1, "a");		// not passed
	}
}
