...
public  class LogicalPlan {
    ...
    */
     ...
     */ 
    public DbIterator physicalPlan(TransactionId t, HashMap<String,TableStats> baseTableStats, boolean explain) throws ParsingException, NoSuchFieldException {
        Iterator<LogicalScanNode> tableIt = tables.iterator();
    ...
    public static void main(String argv[]) {
        ...
        */
        ...
        } catch (ParsingException | NoSuchFieldException e) {
            e.printStackTrace();
            System.exit(0);
        }
        // and run it
