...
public class Parser {
    ...
    public static DbIterator parseQuery(TransactionId tid, ZQuery q) throws IOException, Zql.ParseException, simpledb.ParsingException, NoSuchFieldException {
        return parseQueryLogicalPlan(tid, q).physicalPlan(tid, statsMap, explain);
    }

    static Transaction curtrans = null;

    public static void handleQueryStatement(ZQuery s) throws TransactionAbortedException, DbException, IOException, simpledb.ParsingException, Zql.ParseException, NoSuchElementException, NoSuchFieldException {
        // and run it
        DbIterator node;
    ...
    public static void handleInsertStatement(ZInsert s) throws TransactionAbortedException, DbException, IOException, simpledb.ParsingException, Zql.ParseException, NoSuchFieldException {
        int id;
        try {
    ...
    public static void handleDeleteStatement(ZDelete s) throws TransactionAbortedException, DbException, IOException, simpledb.ParsingException, Zql.ParseException, NoSuchFieldException {
        int id;
        try {
            id = Database.getCatalog().getTableId(s.getTable()); //will fall through if table doesn't exist
        } catch (NoSuchElementException | NoSuchFieldException e) {
    ...
    public static void main(String argv[]) throws IOException, NoSuchFieldException {
