...
public class Parser {
    ...
    public static void handleQueryStatement(ZQuery s) throws TransactionAbortedException, DbException, IOException, simpledb.ParsingException, Zql.ParseException, NoSuchFieldException {
        // and run it
        DbIterator node;
